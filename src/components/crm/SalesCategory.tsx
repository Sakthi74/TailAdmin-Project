...
const SalesCategory = () => {
  ...
  return (
    <div className="bg-white rounded-2xl border p-4 w-full min-h-[302px] flex flex-col  dark:bg-[#171F2E] dark:border-white/10 gap-5">
      ...
      <div>
        <div className="flex flex-col sm:flex-row md:flex-col lg:flex-row items-center flex-1 gap-6">
          <div className="relative w-full sm:w-1/2 md:w-full lg:w-1/2 h-[200px] shrink-0">
          ...
          <div className="flex flex-col md:flex-row gap-4 w-full sm:w-1/2 md:w-full lg:w-1/2 items-center justify-center">
